...
| Total Pages Scraped | 3,318 | |
| **Total Unique Files** | **69,470** | Deduplicated count |
| Total File References | 164,150 | Including duplicates |
| Duplication Rate | 57.7% | Files appearing on multiple pages |
| Pages with New Content | 1,510 | |
| True Pagination Wraps | 168 | Exact duplicate pages |
| Redundant Pages | 1640 | No new files, not exact match |
| EFTA Range | EFTA00039025 - EFTA00539216 | |
...
*...and 138 more true wraps (see pagination_index.json)*
...
| 3000-3499 | EFTA00336521 | EFTA00539216 | 2,593 |
...
3. **Full scrape required**: Must scrape all 8150+ pages to ensure completeness.
...
1. Scraping each page from 0 to 3317 with 1-second delays
...
*Scrape completed: February 02, 2026 at 07:28:13*  
